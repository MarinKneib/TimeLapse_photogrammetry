...
homedir = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/'
resultsdir = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/RESULTS_v1/'
CAMsel_dir = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/RESULTS_v1/CAM_selection/'
...
for ii in [1757]:
    ...
    doc.clear()
    path = ''.join(['X:/Partage/MESANGE/argentiere_courtes_time-lapse/TL_Arg_',date_str[5:22],'_wPGCPs_TLCAM_testscripts.psx'])
    doc.save(path)
    ...
    path_photos_CAM1 = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM1'
    path_photos_CAM2 = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM2'
    path_photos_CAM2B = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM2B'
    path_photos_CAM2N = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM2N'
    path_photos_CAM3 = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM3'
    path_photos_CAM4 = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM4'
    path_photos_CAM4B = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM4B'
    path_photos_CAM4N = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM4N'
    path_photos_CAM4QUALI = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM4QUALI'
    path_photos_CAM5 = 'X:/Partage/MESANGE/argentiere_courtes_time-lapse/Images/CAM5'
    ...
    for camera in chunk.cameras:
        ...
        # if it's camera 3 and we're 07/02/2024 or lqter, it has been replaced with camera 4B
        if camera.label[:4] == 'CAM3' and ii>1324:
            filename = ''.join([resultsdir,'CAMCalib_CAM4B_2023-09-27_130000.txt'])
        else:
            filename = ''.join([resultsdir,'CAMCalib_',camera.label[:len(camera.label)-17],'2023-09-27_130000.txt'])
    ...
    # Import PGCPs
    chunk.importReference(path=''.join([homedir,'PseudoGCPs_forCAM_ref.csv']),format=Metashape.ReferenceFormatCSV,\
